...
<p align="center">
Graduating top of my class, with a strong focus on building scalable and high-performance backend systems.Developer, graduating top of my class, with a strong specialization in backend systems and RESTful API development. My work emphasizes clean code principles, clean architecture, and high-performance solutions for real-world.
</p>
...
- 💻 Specialized in **Backend Development & RESTful APIs**
- 🧠 Strong believer in **Clean Code & Clean Architecture**
- ⚙️ Experienced with **ASP.NET Core, Entity Framework, SQL Server**
- 🔐 Focused on **Security, Authentication & System Design**
